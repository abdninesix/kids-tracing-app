...
urdu: {
        'الف': "M150 35 L150 335",
        'ب': "M50 300 L150 300 C250 300 250 300 150 300 L50 300 Z M150 350 L150 350", // Simple path, you may need to adjust the curve
        'پ': "M30 300 L150 300 C270 300 270 300 150 300 L30 300 Z M150 350 L150 350 M100 350 L100 350 M200 350 L200 350", // Teen nuqte
        'ت': "M50 300 L150 300 C250 300 250 300 150 300 L50 300 Z M100 250 L100 250 M200 250 L200 250", // Do nuqte oopar
        'ٹ': "M50 300 L150 300 C250 300 250 300 150 300 L50 300 Z M150 80 A30 30 0 1 1 150 80 Z", // Tou-e (chhote toye ke liye)
        'ث': "M50 300 L150 300 C250 300 250 300 150 300 L50 300 Z M150 200 L150 200 M100 250 L100 250 M200 250 L200 250", // Teen nuqte oopar
        ...
        'خ': "M250 150 C250 50 150 50 150 150 L150 250 C150 350 50 350 50 250 M100 80 L100 80", // Ek nuqta oopar
        'د': "M100 35 L100 150 L200 150",
        'ڈ': "M100 35 L100 150 L200 150 M150 10 A10 10 0 1 1 150 10 Z", // Tou-e
        'ذ': "M100 35 L100 150 L200 150 M100 350 L100 350", // Ek nuqta oopar
        'ر': "M100 35 L100 250 L200 250 L200 335",
        'ڑ': "M100 35 L100 250 L200 250 L200 335 M150 50 A10 10 0 1 1 150 50 Z", // Tou-e
        'ز': "M100 35 L100 250 L200 250 L200 335 M100 300 L100 300", // Ek nuqta
        'ژ': "M100 35 L100 250 L200 250 L200 335 M150 200 L150 200 M100 250 L100 250 M200 250 L200 250", // Teen nuqte
        'س': "M50 300 C100 250 150 250 200 300 L250 300 L250 350 C200 350 100 350 50 350",
        'ش': "M50 300 C100 250 150 250 200 300 L250 300 L250 350 C200 350 100 350 50 350 M150 100 L150 100 M100 150 L100 150 M200 150 L200 150", // Teen nuqte
        'ص': "M50 200 C100 100 200 100 250 200 L250 350 C200 350 100 350 50 350",
        'ض': "M50 200 C100 100 200 100 250 200 L250 350 C200 350 100 350 50 350 M100 100 L100 100", // Ek nuqta
        'ط': "M100 50 L100 300 M100 300 H250",
        'ظ': "M100 50 L100 300 M100 300 H250 M150 50 L150 50", // Ek nuqta
        'ع': "M200 150 C200 50 100 50 100 150 L100 350",
        'غ': "M200 150 C200 50 100 50 100 150 L100 350 M100 50 L100 50", // Ek nuqta
        'ف': "M150 150 C200 150 200 250 150 250 C100 250 100 150 150 150 Z M150 300 L150 350 M150 100 L150 100", // Golai aur nuqta
        'ق': "M150 150 C200 150 200 250 150 250 C100 250 100 150 150 150 Z M150 300 L150 350 M120 100 L120 100 M180 100 L180 100", // Do nuqte
        'ک': "M100 35 L100 335 M100 150 L200 150 M150 100 L200 50", // Simple kaaf
        'گ': "M100 35 L100 335 M100 150 L200 150 M150 100 L200 50 M250 150 L250 100", // Do dande
        'ل': "M150 35 L150 335 C150 350 100 350 100 335",
        'م': "M150 100 C200 100 200 200 150 200 L150 335",
        'ن': "M150 50 C250 50 250 350 150 350 C50 350 50 50 150 50 Z M150 200 L150 200", // Nuqta beech mein
        ...
        'ی': "M50 300 C150 200 250 200 250 300 M100 350 L100 350 M200 350 L200 350", // Badi ye
        'ے': "M50 300 C150 200 250 200 250 300", // Chhoti ye (ya bari ye ka shuru)
    },
  // --- SHAPES ---
...
const getPathForItem = (item, categoryId) => {
  ...
  if (categoryId === "letters") {
    return PATHS[item.toUpperCase()] || null;
        ...
        // Urdu characters ko direct key se uthayenge
        return PATHS.urdu[item] || null;}
  
  else if (categoryId === "numbers") {
    return PATHS[item] || null;
  } else if (categoryId === "shapes") {
    const properCaseItem =
